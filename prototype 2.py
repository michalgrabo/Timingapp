...
def loading(filename):
    ...
    with open("pickleforstorage", "rb") as infile:
...
def open_window():
    ...
    def analyse():
        ...
        #loading("final_storage_pickle")

        window3.bg = "#205a60"
        window3.show(wait=True)
        app.hide()
        side1_box2 = Box(window3, width= 20, height = "fill", align = "right", border = False)
        side2_box2 = Box(window3, width= 20, height = "fill", align = "left", border = False)
        ...
        fast = Text(fastesttime, text = "Fastest time: " , align="left", size = 20, color = "#f2e4d9")
        slow = Text(slowesttime, text = "Slowest time: " , align="left", size = 20, color = "#f2e4d9")
        avg = Text(averagetime, text = "Average time: " , align="left", size = 20, color = "#f2e4d9")
        continuebutton = PushButton(window3, text="Continue", command = destruction2, width= 10, height= 5)
        ...
        final_index = all_indexes_list(times_and_age_reconstructed, requested_age)
        ...
        average_times_per_age = sum(analyse_times)/ lenght
        fast = Text(fastesttime, text = "Fastest time for age group: " + str(fastest_times_per_age), align="left", size = 20, color = "#f2e4d9")
        slow = Text(slowesttime, text = "Slowest time for age group: " + str(slowest_times_per_age), align="left", size = 20, color = "#f2e4d9")
        avg = Text(averagetime, text = "Average time for age group: " + str(average_times_per_age), align="left", size = 20, color = "#f2e4d9")
...
def login_window():
    ...
    age = Text(agetittle, text = "Enter year group:", align="left", size = 20, color = "#f2e4d9")
    def textbox_changed():
...
def check():
    ...
    if int(final_participant_age) <= 18 and int(final_participant_age) >= 12:
        destruction1()
        all_age_list.append(final_participant_age)
        all_average_list.append(average_times)
        print(all_age_list)
        print(all_average_list)
        save(all_average_list, "final_storage_pickle")
